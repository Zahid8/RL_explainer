...
- Whole-book search index at `/search`, plus search consoles on the homepage and every chapter page, indexing the standalone prose and technical explanations across chapter overviews, zero-primer rungs, lecture theater slides, active recall, concepts, worked examples, misconception repairs, simulators, manuscripts, section lessons, synthesis/dependency gates, source audits, algorithm cards, deep dives, mastery notes, formulas, figure/example anchors, and exercise guides.
- Interactive learning graph at `/graph`, plus graph consoles on the homepage and every chapter page, mapping prerequisites, concepts, formulas, algorithms, worked examples, practice prompts, simulator knobs, and later unlocks as a clickable graphical lecture map.
...
- Chapter-by-chapter explorer for all 17 chapters, with:
  ...
  - an interactive chapter learning graph for every chapter showing how prerequisites, concepts, formulas, methods, examples, practice, simulator knobs, and next-chapter unlocks connect,
...
- Whole-book coverage audit page at `/coverage` proving chapter route coverage, whole-book search-index coverage, interactive learning-graph coverage, zero-knowledge starter coverage, guided lecture theater coverage, active-recall practice coverage, concept microscope coverage, worked example coverage, misconception clinic coverage, chapter simulator lab coverage, manuscript coverage, section-level textbook coverage, guided section lecture coverage, interactive formula lecture coverage, interactive blackboard coverage, and algorithm detail-layer completeness from current repository data.
...
- `src/lib/learningGraph.ts` - chapter learning-graph data derived from concepts, formulas, algorithms, examples, practice prompts, simulators, and dependency maps.
