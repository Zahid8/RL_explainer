...
- Linear standalone book reader at `/book`, rendering all 17 chapters in order with table-of-contents anchors, zero-knowledge starter ladders, foundation dictionary studios, math rescue studios, visual story studios, analogy bridge studios, Socratic tutor studios, case study studios, project studios, evidence replay studios, guided lecture theaters, active-recall practice coaches, concept microscopes, worked example studios, misconception clinics, chapter simulator labs, bespoke manuscript prose, clickable interactive blackboards, full section-level textbook manuscripts, guided section lecture controls, section mastery studios, contextual symbol decoders, implementation code labs, assumption guarantee clinics, method comparison studios, proof intuition labs, chapter exam studios, interactive formula lecture controls, from-zero explanations, visual mental models, section lecture beats, board-work steps, whole-book search links, and links to full chapter labs.
- Whole-book search index at `/search`, plus search consoles on the homepage and every chapter page, indexing the standalone prose and technical explanations across chapter overviews, zero-primer rungs, lecture theater slides, active recall, concepts, worked examples, misconception repairs, simulators, manuscripts, section lessons, synthesis/dependency gates, source audits, algorithm cards, deep dives, mastery notes, formulas, contextual symbol cards, implementation code labs, assumption clinics, method comparison cards, foundation dictionary cards, math rescue cards, visual story scenes, analogy bridge cards, Socratic tutor cards, case study cards, project cards, evidence replay cards, proof labs, chapter exam cards, figure/example anchors, and exercise guides.
- Interactive learning graph at `/graph`, plus graph consoles on the homepage and every chapter page, mapping prerequisites, concepts, formulas, decoded symbols, algorithms, implementation code labs, algorithm debugging clinics, assumption clinics, method comparison boards, foundation terms, math rescue objects, visual story scenes, analogy bridge cards, Socratic tutor cards, case study cards, project cards, evidence replay cards, proof labs, chapter exam prompts, section mastery checks, worked examples, practice prompts, simulator knobs, and later unlocks as a clickable graphical lecture map.
...
- Algorithm debugging clinic at `/debug`, plus debug consoles on the homepage, `/book`, and every chapter page, with 109 algorithm failure-diagnosis cards, 545 modes across symptom, diagnose, repair, test, and transfer views, 654 repair steps, and 545 test-fixture checks.
...
- Method comparison studio at `/compare`, plus comparison consoles on the homepage, `/book`, and every chapter page, with 109 method-choice cards and 545 modes across choose, axis, tradeoff, failure, and bridge views.
- Foundation dictionary studio at `/foundations`, plus dictionary consoles on the homepage, `/book`, and every chapter page, with 238 foundation cards, 199 unique terms, 5 source layers, and 1190 modes across plain meaning, board picture, technical role, common trap, and teach-back views.
- Math rescue studio at `/math`, plus math consoles on the homepage, `/book`, and every chapter page, with 170 rescue cards, 168 unique mathematical objects, 209 symbol handles, 4 source layers, and 850 modes across intuition, board picture, notation bridge, chapter use, and self-check views.
- Visual story studio at `/stories`, plus story consoles on the homepage, `/book`, and every chapter page, with 136 scene cards and 680 modes across scene, observe, move, technical, and check views.
- Analogy bridge studio at `/analogies`, plus analogy consoles on the homepage, `/book`, and every chapter page, with 102 analogy cards, 408 mapping/board rows, 6 source layers, and 510 modes across everyday, mapping, technical, limits, and transfer views.
- Socratic tutor studio at `/tutor`, plus tutor consoles on the homepage, `/book`, and every chapter page, with 102 tutor cards, 510 dialogue turns, 408 board steps, 6 source layers, and 510 modes across question, hint, board, technical, and try-it views.
- Case study studio at `/cases`, plus case-study consoles on the homepage, `/book`, and every chapter page, with 68 complete chapter cases, 272 board frames, 272 success checks, 4 source layers, and 340 modes across scene, walkthrough, technical, debug, and transfer views.
- Project studio at `/projects`, plus project consoles on the homepage, `/book`, and every chapter page, with 51 hands-on chapter projects, 255 build milestones, 272 rubric checks, 204 deliverables, 3 source types, and 255 modes across brief, build, experiment, rubric, and extend views.
- Evidence replay studio at `/evidence`, plus evidence consoles on the homepage, `/book`, and every chapter page, with 147 figure/table/example replays, 735 read/reconstruct/technical/pitfall/transfer modes, 588 reconstruction steps, 17 covered chapters, and 3 source kinds.
...
- Chapter-by-chapter explorer for all 17 chapters, with:
  ...
  - a foundation dictionary studio for every chapter so terms are learned as plain meaning, board picture, exact technical object, common trap, and teach-back before formulas use them,
  - a math rescue studio for every chapter so expectations, returns, backups, gradients, ratios, traces, projections, and updates are explained from intuition to notation before dense formulas use them,
  - a visual story studio for every chapter so concrete scenes, learner observations, board motions, technical translations, and blank-board checks appear before formal notation,
  - an analogy bridge studio for every chapter so everyday intuition is mapped into exact RL objects with explicit limits and transfer checks,
  - a Socratic tutor studio for every chapter so beginner questions become hints, board traces, technical answers, and try-it prompts,
  - a case study studio for every chapter so scene, board walkthrough, technical translation, debug probe, and transfer challenge are joined into complete RL scenarios,
  - a project studio for every chapter so case artifacts, implementation experiments, capstone teach-backs, rubric checks, and transfer extensions prove the ideas can be used,
  - an evidence replay studio for every chapter so figures, tables, and named examples are read, rebuilt from memory, translated technically, debugged for common traps, and transferred to new toy worlds,
  ...
  - a foundation dictionary studio that defines chapter terms before dense notation or algorithm comparisons use them,
  - a math rescue studio that turns chapter calculations into intuition, board picture, notation bridge, chapter use, and no-notes self-check,
  - a visual story studio that turns chapter ideas into concrete learner-world-feedback scenes before formulas,
  - an analogy bridge studio that turns familiar stories into precise RL mappings without pretending the analogy is proof,
  - a Socratic tutor studio that turns each anchor into a learner question, hint, board sequence, technical answer, and fresh attempt,
  - a case study studio that turns chapter ideas into end-to-end learner-world-feedback cases with board frames, technical passes, debug probes, and transfer tests,
  - a project studio that turns each chapter into buildable artifacts, controlled experiments, grading rubrics, and extension challenges,
  ...
  - an algorithm debugging clinic for every chapter so each algorithm failure becomes symptom diagnosis, broken-assumption isolation, one-cause repair, tiny-fixture retest, and transfer practice,
  ...
  - a method comparison studio for every chapter so nearby algorithms are compared by data access, target, model use, backup style, approximation, tradeoff, and failure risk,
  ...
  - an exercise solution studio for numbered practice anchors so readers attempt first, request hints, reveal original solution paths, debug, and extend,
  - an interactive chapter learning graph for every chapter showing how prerequisites, concepts, formulas, decoded symbols, methods, implementation scaffolds, assumptions, guarantees, exam prompts, section mastery checks, exercise solution nodes, examples, practice, simulator knobs, and next-chapter unlocks connect,
...
- Evidence replay studio with 147 original replay cards built from those anchors:
  - read mode for the plain interpretation,
  - reconstruct mode with 588 total rebuild steps,
  - technical mode for exact RL language,
  - pitfall mode for common misreads,
  - transfer mode for applying the mechanism to a new toy world.
...
- Exercise solution studio with 145 original solution-path cards and 725 modes across attempt, hint, solution, debug, and extension views.
- Standalone, highly detailed chapter pages for every chapter, each combining:
  ...
  - Foundation dictionary studio that turns prerequisite, vocabulary, concept, formula, and algorithm terms into meaning/picture/technical/trap/teach-back cards,
  - Math rescue studio that turns formulas, concepts, algorithm updates, and starter premises into intuition/picture/notation/use/check cards,
  - Visual story studio that turns chapter ideas into concrete learner-world-feedback scenes before formulas,
  - Analogy bridge studio that maps familiar examples to exact RL objects while naming limits,
  - Socratic tutor studio that turns beginner questions into hints, board steps, technical answers, and try-it prompts,
  - Case study studio that runs complete scenarios through scene, board walkthrough, technical translation, debug probe, and transfer challenge,
  - Project studio that turns each chapter into a case artifact, an implementation experiment, and a mastery capstone with deliverables and rubrics,
  - Evidence replay studio that turns figure/table/example anchors into read, reconstruct, technical, pitfall, and transfer lectures without reproducing source artwork,
  ...
  - Exercise solution studio that turns numbered exercise anchors into attempt/hint/solution/debug/extension workflows without copying exercise text,
  ...
  - Algorithm debugging clinic that teaches symptom naming, diagnostic traces, one-cause repairs, tiny test fixtures, and transfer rules for every chapter algorithm,
  ...
  - Method comparison studio that explains when to choose each method over a nearby alternative by inspecting target construction, profile axes, tradeoffs, failure checks, and transfer bridges,
...
- Whole-book coverage audit page at `/coverage` proving chapter route coverage, whole-book search-index coverage, interactive learning-graph coverage, foundation dictionary-studio coverage, math rescue-studio coverage, visual story-studio coverage, analogy bridge-studio coverage, Socratic tutor-studio coverage, case study-studio coverage, project-studio coverage, contextual symbol-decoder coverage, implementation code-lab coverage, assumption guarantee-clinic coverage, method comparison-studio coverage, proof intuition-lab coverage, chapter exam-studio coverage, section mastery-studio coverage, exercise solution-studio coverage, zero-knowledge starter coverage, guided lecture theater coverage, active-recall practice coverage, concept microscope coverage, worked example coverage, misconception clinic coverage, chapter simulator lab coverage, manuscript coverage, section-level textbook coverage, guided section lecture coverage, interactive formula lecture coverage, interactive blackboard coverage, and algorithm detail-layer completeness from current repository data.
- Animated and interactive graphics throughout the site: every homepage section, chapter header/story block, guided lecture theater, contextual symbol decoder, implementation code lab, assumption guarantee clinic, method comparison studio, foundation dictionary studio, math rescue studio, visual story studio, analogy bridge studio, Socratic tutor studio, case study studio, project studio, evidence replay studio, proof intuition lab, chapter exam studio, section mastery studio, exercise solution studio, concept microscope, worked example studio, misconception clinic, chapter simulator lab, chapter section heading, formula reader, algorithm card, global algorithm index card/chapter cluster, and coverage section gets reusable hover/click reinforcement-learning motion sketches; every chapter also has a 4-stage blackboard; dense explanation cards, metrics, panels, proof blocks, exam cards, section mastery cards, method comparison cards, foundation dictionary cards, math rescue cards, visual story cards, analogy bridge cards, Socratic tutor cards, case study cards, project cards, evidence replay cards, exercise solution cards, notes, and study-route cards use animated micro-glyphs.
...
- `src/lib/evidenceReplay.ts` - evidence replay cards derived from figure/table/example anchors, with read, reconstruct, technical, pitfall, and transfer modes plus coverage helpers.
- `src/lib/algorithmDebug.ts` - algorithm debugging clinic cards derived from algorithm failure modes, code-lab tests, and assumption-clinic repairs, with symptom, diagnose, repair, test, and transfer modes.
- `src/lib/exerciseCoach.ts` - 145 exercise-coach cards generated from the PDF exercise anchors without copying exercise text.
- `src/lib/exerciseSolutionStudio.ts` - 145 exercise solution cards derived from exercise coaches and chapter metadata, with attempt, hint, solution, debug, and extension modes.
...
- `src/lib/methodCompare.ts` - method-comparison data derived from algorithm cards and technical profiles, with choose, axis, tradeoff, failure, and bridge modes.
- `src/lib/foundationDictionary.ts` - foundation vocabulary cards generated from starter rungs, chapter vocabulary, concept cards, formula cards, and algorithm cards, with meaning, picture, technical, trap, and teach-back modes.
- `src/lib/mathRescue.ts` - mathematical prerequisite rescue cards generated from formulas, concept cards, algorithm updates, and starter premises, with intuition, picture, notation, use, and self-check modes.
- `src/lib/socraticTutor.ts` - Socratic tutor cards generated from starter rungs, concepts, math rescue cards, visual stories, analogies, and algorithms, with question, hint, board, technical, and try-it modes.
- `src/lib/caseStudies.ts` - case-study data generated from visual stories, worked examples, algorithms, simulators, misconceptions, analogies, concepts, and tutors, with scene, walkthrough, technical, debug, and transfer modes.
- `src/lib/projectStudio.ts` - project-studio data generated from case studies, simulators, code labs, method comparisons, exercise solutions, and exams, with brief, build, experiment, rubric, and extend modes.
...
- `src/lib/learningGraph.ts` - chapter learning-graph data derived from concepts, formulas, decoded symbols, algorithms, implementation code labs, assumption clinics, method comparison boards, proof labs, chapter exam prompts, section mastery checks, exercise solution nodes, examples, practice prompts, simulators, and dependency maps.
...
- `src/components/MethodCompareStudio.tsx` - client-side comparison console for choosing method cards and switching among choose, axis, tradeoff, failure, and bridge modes.
- `src/components/FoundationDictionaryStudio.tsx` - client-side dictionary console for choosing foundation terms and switching among meaning, picture, technical, trap, and teach-back modes.
- `src/components/MathRescueStudio.tsx` - client-side math rescue console for choosing mathematical objects and switching among intuition, picture, notation, chapter use, and self-check modes.
- `src/components/VisualStoryStudio.tsx` - client-side story console for choosing graphical scenes and switching among scene, observe, move, technical, and check modes.
- `src/components/AnalogyStudio.tsx` - client-side analogy console for choosing familiar bridges and switching among everyday, mapping, technical, limits, and transfer modes.
- `src/components/SocraticTutorStudio.tsx` - client-side tutor console for choosing question-led cards and switching among question, hint, board, technical, and try-it modes.
- `src/components/CaseStudyStudio.tsx` - client-side case-study console for choosing complete cases and switching among scene, walkthrough, technical, debug, and transfer modes.
- `src/components/ProjectStudio.tsx` - client-side project console for choosing chapter projects and switching among brief, build, experiment, rubric, and extend modes.
- `src/components/EvidenceReplayStudio.tsx` - client-side evidence console for choosing figure/table/example anchors and switching among read, reconstruct, technical, pitfall, and transfer modes.
- `src/app/cases/page.tsx` - whole-book case-study route with case counts, chapter links, source-layer links, and the full CaseStudyStudio.
- `src/app/projects/page.tsx` - whole-book project route with project counts, chapter links, source-layer links, and the full ProjectStudio.
- `src/app/evidence/page.tsx` - whole-book evidence replay route with replay counts, chapter links, and the full EvidenceReplayStudio.
...
- `src/components/ExerciseSolutionStudio.tsx` - client-side exercise solution console for choosing exercise cards and switching among attempt, hint, solution, debug, and extension modes.
...
- `src/app/compare/page.tsx` - whole-book method comparison studio page for method-choice, technical-axis, tradeoff, failure, and transfer comparisons.
- `src/app/foundations/page.tsx` - whole-book foundation dictionary page for first-principles RL vocabulary, source blends, and chapter links.
- `src/app/math/page.tsx` - whole-book math rescue page for prerequisite calculations, source blends, symbols, and chapter links.
- `src/app/stories/page.tsx` - whole-book visual story page for chapter scenes, source blends, actor/prop handles, and chapter links.
- `src/app/analogies/page.tsx` - whole-book analogy bridge page for familiar mappings, source blends, anchor counts, and chapter links.
- `src/app/tutor/page.tsx` - whole-book Socratic tutor page for learner questions, hints, board steps, technical answers, source blends, and chapter links.
...
- `src/app/exercises/page.tsx` - whole-book exercise solution studio page for attempt, hint, solution, debug, and extension workflows.
