...
- Interactive learning graph at `/graph`, plus graph consoles on the homepage and every chapter page, mapping prerequisites, concepts, formulas, decoded symbols, algorithms, implementation code labs, assumption clinics, method comparison boards, foundation terms, math rescue objects, visual story scenes, analogy bridge cards, Socratic tutor cards, case study cards, project cards, evidence replay cards, proof labs, chapter exam prompts, section mastery checks, worked examples, practice prompts, simulator knobs, and later unlocks as a clickable graphical lecture map.
