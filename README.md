...
- `src/lib/algorithmCatalog.ts`, `src/lib/algorithmDossier.ts`, and `src/lib/algorithmWorkedExamples.ts` - 109 detailed algorithm/procedure cards keyed by chapter, with dossier and worked-example enrichment.
