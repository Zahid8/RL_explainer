            ...
            <div className="grid gap-4">
              ...
              <div className="rounded-xl border border-line bg-white p-5">
                ...
                <ol className="grid gap-2 text-sm leading-relaxed text-muted">
                  ...
                  <li>6. Open the section beats and translate each picture into technical language.</li>
                  <li>7. Use the section mastery studio to try each named section cold before chapter-level drills.</li>
                  <li>8. Use the full chapter page for algorithms, formulas, exercises, and interactive detail.</li>
                  <li>9. Use the search index when you remember a term but not the chapter.</li>
                  <li>10. Use the learning graph when you need to see why a concept, formula, algorithm, and example belong together.</li>
...
function BookChapter({ chapter, lecture, starter, starterModes, foundationCards, foundationModes, mathCards, mathModes, storyCards, storyModes, theater, theaterSlides, theaterModes, practiceCards, practiceModes, conceptCards, conceptModes, workedExamples, workedExampleModes, misconceptionCards, misconceptionModes, simulator, simulatorControls, simulatorReadouts, manuscript, blackboard, sectionLessons, sectionMasteryCards, sectionMasteryModes, symbolCards, symbolModes, codeCards, codeModes, assumptionCards, assumptionModes, compareCards, compareModes, proofCards, proofModes, examCards, examModes, formulas, formulaModes }: { chapter: (typeof chapters)[number]; lecture: StandaloneChapterLecture; starter: ZeroKnowledgeLadder; starterModes: number; foundationCards: FoundationDictionaryCard[]; foundationModes: number; mathCards: MathRescueCard[]; mathModes: number; storyCards: VisualStoryCard[]; storyModes: number; theater: ChapterLectureTheaterData; theaterSlides: number; theaterModes: number; practiceCards: ChapterPracticeCard[]; practiceModes: number; conceptCards: ChapterConceptCard[]; conceptModes: number; workedExamples: ChapterWorkedExample[]; workedExampleModes: number; misconceptionCards: ChapterMisconceptionCard[]; misconceptionModes: number; simulator: ChapterSimulator; simulatorControls: number; simulatorReadouts: number; manuscript: ChapterManuscript; blackboard: ChapterBlackboard; sectionLessons: SectionTextbookLesson[]; sectionMasteryCards: SectionMasteryCard[]; sectionMasteryModes: number; symbolCards: SymbolCard[]; symbolModes: number; codeCards: CodeLabCard[]; codeModes: number; assumptionCards: AssumptionClinicCard[]; assumptionModes: number; compareCards: MethodCompareCard[]; compareModes: number; proofCards: ProofLabCard[]; proofModes: number; examCards: ChapterExamCard[]; examModes: number; formulas: FormulaNote[]; formulaModes: number }) {
