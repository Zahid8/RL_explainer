    ...
    <main className="min-h-screen bg-bg text-ink">
      ...
      <div className="mx-auto grid max-w-[1280px] gap-12 px-6 py-12 lg:px-10">
        ...
        <section id="chapter-matrix" className="scroll-mt-24">
          <SectionTitle eyebrow="02 - Chapter coverage matrix" title="Every chapter route and every major study layer in one audit table." lead="Open any chapter to inspect the rendered detail layers: chapter search index, foundation dictionary studio, math rescue studio, visual story studio, analogy bridge studio, Socratic tutor studio, case study studio, project studio, evidence replay studio, interactive learning graph, contextual symbol decoder, implementation code lab, assumption guarantee clinic, method comparison studio, proof intuition lab, chapter exam studio, section mastery studio, exercise solution studio, guided lecture theater, concept microscope, worked example studio, misconception clinic, chapter simulator lab, manuscript, interactive blackboard, interactive section lecturer, section-level textbook prose, standalone lecture, synthesis, dependencies, source audit, algorithms, deep dives, mastery notes, formulas, anchors, and exercises." />
...
function ChapterCoverageCard({ chapter }: { chapter: ChapterCoverageRow }) {
  return (
    <article className="rounded-xl border border-line bg-panel p-5">
      ...
      <div className="mt-4 grid gap-3 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-[repeat(71,minmax(0,1fr))]">
