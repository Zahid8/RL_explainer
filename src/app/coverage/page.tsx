...
const visualInteractionRows = [
  {
    ...
    coverage: "All 14 overview sections render an animated concept graphic through the shared Section wrapper or a dedicated interactive lecture console.",
    ...
    <main className="min-h-screen bg-bg text-ink">
      ...
      <div className="mx-auto grid max-w-[1280px] gap-12 px-6 py-12 lg:px-10">
        ...
        <section id="chapter-matrix" className="scroll-mt-24">
          <SectionTitle eyebrow="02 - Chapter coverage matrix" title="Every chapter route and every major study layer in one audit table." lead="Open any chapter to inspect the rendered detail layers: concept microscope, worked example studio, misconception clinic, manuscript, interactive blackboard, interactive section lecturer, section-level textbook prose, standalone lecture, synthesis, dependencies, source audit, algorithms, deep dives, mastery notes, formulas, anchors, and exercises." />
...
function ChapterCoverageCard({ chapter }: { chapter: ChapterCoverageRow }) {
  return (
    <article className="rounded-xl border border-line bg-panel p-5">
      ...
      <div className="mt-4 grid gap-3 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-[repeat(24,minmax(0,1fr))]">
