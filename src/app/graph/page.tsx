...
export const metadata: Metadata = {
  ...
  description: "A clickable graphical map connecting RLbook concepts, formulas, decoded symbols, algorithms, code scaffolds, assumptions, proof sketches, examples, practice, and simulators chapter by chapter.",
};
          ...
          <div className="grid gap-8 lg:grid-cols-[1fr_440px] lg:items-end">
            <div>
              ...
              <p className="mt-5 max-w-3xl text-lg leading-relaxed text-muted">
                This is the graphical lecture map for the standalone book. Each chapter becomes a clickable network of prerequisites, concepts, formulas, decoded symbols, algorithms, code scaffolds, assumption clinics, proof labs, worked examples, practice checkpoints, simulator knobs, and later unlocks.
              </p>
            ...
            <div className="grid gap-4">
              <AnimatedConceptGraphic label="Learning graph" variant="tree" caption="The graph turns the book into a map: prerequisite ideas feed chapter concepts, concepts become notation, notation becomes algorithms, algorithms become code scaffolds, proof sketches, and assumption checks, then scaffolds become worked traces and practice." compact />
