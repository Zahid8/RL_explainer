        ...
        <div className="mx-auto max-w-[1280px] px-6 py-8 lg:px-10">
          ...
          <div className="grid gap-8 lg:grid-cols-[1fr_440px] lg:items-end">
            ...
            <div className="grid gap-4">
              <AnimatedConceptGraphic label="Learning graph" variant="tree" caption="The graph turns the book into a map: prerequisite ideas feed chapter concepts, concepts become notation, notation becomes algorithms, and algorithms become worked traces and practice." compact />
