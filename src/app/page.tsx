...
export default function Home() {
  ...
  return (
    <main>
      ...
      <Section
        id="assumptions"
        eyebrow="00n - Assumption guarantee clinic"
      ...
      <Section
        id="compare"
        eyebrow="00o - Method comparison studio"
      ...
      <Section
        id="proofs"
        eyebrow="00p - Proof intuition lab"
      ...
      <Section
        id="exam"
        eyebrow="00q - Chapter exam studio"
      ...
      <Section
        id="recall"
        eyebrow="00r - Active recall coach"
      ...
      <Section
        id="concepts"
        eyebrow="00s - Concept microscope"
      ...
      <Section
        id="worked"
        eyebrow="00t - Worked example studio"
      ...
      <Section
        id="clinic"
        eyebrow="00u - Misconception clinic"
      ...
      <Section
        id="simulators"
        eyebrow="00v - Chapter simulator lab"
