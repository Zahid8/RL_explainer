...
export default function Home() {
  ...
  return (
    <main>
      ...
      <Section
        id="compare"
        eyebrow="00j - Method comparison studio"
      ...
      <Section
        id="proofs"
        eyebrow="00k - Proof intuition lab"
      ...
      <Section
        id="exam"
        eyebrow="00l - Chapter exam studio"
      ...
      <Section
        id="recall"
        eyebrow="00m - Active recall coach"
      ...
      <Section
        id="concepts"
        eyebrow="00n - Concept microscope"
      ...
      <Section
        id="worked"
        eyebrow="00o - Worked example studio"
      ...
      <Section
        id="clinic"
        eyebrow="00p - Misconception clinic"
      ...
      <Section
        id="simulators"
        eyebrow="00q - Chapter simulator lab"
