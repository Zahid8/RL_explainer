...
export default function Home() {
  ...
  return (
    <main>
      ...
      <Section
        id="math"
        eyebrow="00d - Math rescue studio"
      ...
      <Section
        id="stories"
        eyebrow="00e - Visual story studio"
      ...
      <Section
        id="analogies"
        eyebrow="00f - Analogy bridge studio"
      ...
      <Section
        id="tutor"
        eyebrow="00g - Socratic tutor studio"
      ...
      <Section
        id="theater"
        eyebrow="00j - Guided lecture theater"
