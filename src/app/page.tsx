  ...
  return (
    <main>
      ...
      <Section
        ...
        lead="Search beginner stories, board pictures, technical formulas, algorithm cards, implementation scaffolds, assumptions, guarantees, worked traces, misconceptions, simulator knobs, section manuscripts, figure anchors, and exercise guides across all chapters."
      >
      ...
      <Section
        ...
        lead="The learning graph turns each chapter into a clickable map: prerequisites feed concepts, concepts become notation, notation becomes algorithms, algorithms become code scaffolds, assumptions, guarantees, and worked traces, and practice plus simulator nodes prove transfer."
        tint
      >
      ...
      <Section
        id="recall"
        eyebrow="00i - Active recall coach"
      ...
      <Section
        id="concepts"
        eyebrow="00j - Concept microscope"
      ...
      <Section
        id="worked"
        eyebrow="00k - Worked example studio"
      ...
      <Section
        id="clinic"
        eyebrow="00l - Misconception clinic"
      ...
      <Section
        id="simulators"
        eyebrow="00m - Chapter simulator lab"
