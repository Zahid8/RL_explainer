...
export default function Home() {
  ...
  return (
    <main>
      ...
      <Section
        id="recall"
        eyebrow="00f - Active recall coach"
      ...
      <Section
        id="concepts"
        eyebrow="00g - Concept microscope"
      ...
      <Section
        id="worked"
        eyebrow="00h - Worked example studio"
      ...
      <Section
        id="clinic"
        eyebrow="00i - Misconception clinic"
      ...
      <Section
        id="simulators"
        eyebrow="00j - Chapter simulator lab"
