  ...
  return (
    <main>
      ...
      <Section
        ...
        lead="The learning graph turns each chapter into a clickable map: prerequisites feed concepts, concepts become notation, notation becomes algorithms, algorithms become code scaffolds, proof sketches, assumptions, guarantees, and worked traces, and practice plus simulator nodes prove transfer."
        tint
      >
      ...
      <Section
        id="recall"
        eyebrow="00j - Active recall coach"
      ...
      <Section
        id="concepts"
        eyebrow="00k - Concept microscope"
      ...
      <Section
        id="worked"
        eyebrow="00l - Worked example studio"
      ...
      <Section
        id="clinic"
        eyebrow="00m - Misconception clinic"
      ...
      <Section
        id="simulators"
        eyebrow="00n - Chapter simulator lab"
