...
export default function Home() {
  ...
  return (
    <main>
      ...
      <Section
        id="theater"
        eyebrow="00e - Guided lecture theater"
      ...
      <Section
        id="sections"
        eyebrow="00f - Section mastery studio"
      ...
      <Section
        id="graph"
        eyebrow="00h - Interactive learning graph"
      ...
      <Section
        id="code"
        eyebrow="00j - Implementation code lab"
      ...
      <Section
        id="compare"
        eyebrow="00l - Method comparison studio"
      ...
      <Section
        id="proofs"
        eyebrow="00m - Proof intuition lab"
      ...
      <Section
        id="exam"
        eyebrow="00n - Chapter exam studio"
      ...
      <Section
        id="recall"
        eyebrow="00o - Active recall coach"
      ...
      <Section
        id="concepts"
        eyebrow="00p - Concept microscope"
      ...
      <Section
        id="worked"
        eyebrow="00q - Worked example studio"
      ...
      <Section
        id="clinic"
        eyebrow="00r - Misconception clinic"
      ...
      <Section
        id="simulators"
        eyebrow="00s - Chapter simulator lab"
