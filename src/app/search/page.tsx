...
export const metadata: Metadata = {
  ...
  description: "Search the standalone RL web book across chapters, algorithms, formulas, examples, misconceptions, implementation code labs, assumption clinics, proof labs, chapter exams, and practice layers.",
};
          ...
          <div className="grid gap-8 lg:grid-cols-[1fr_440px] lg:items-end">
            <div>
              ...
              <p className="mt-5 max-w-3xl text-lg leading-relaxed text-muted">
                This page turns the standalone web book into a searchable lecture desk. It indexes chapter stories, zero-knowledge rungs, guided theater slides, contextual symbol cards, implementation code labs, assumption clinics, proof arguments, chapter exams, concepts, worked examples, misconceptions, simulators, manuscripts, section lessons, algorithms, formulas, evidence anchors, and exercise coaches.
              </p>
            ...
            <div className="grid gap-4">
              <AnimatedConceptGraphic label="Whole-book search" variant="tree" caption="A searchable index connects beginner intuition, board pictures, equations, algorithm machinery, code scaffolds, assumptions, guarantees, proof sketches, chapter exams, examples, traps, and exercises across the full course." compact />
