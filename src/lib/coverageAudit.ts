...
function requirementProofs(totals: CoverageAudit["totals"]): RequirementProof[] {
  return [
    ...
    },
    {
      ...
      technical: "bookIndex.ts aggregates chapter stories, zero-primer rungs, foundation dictionary terms, math rescue objects, lecture slides, section mastery cards, symbol cards, active recall, concept cards, examples, misconception repairs, simulators, implementation code labs, assumption clinics, manuscripts, section lessons, synthesis/dependency gates, source audits, algorithms, mastery notes, formulas, evidence anchors, exercise coaches, exercise solution cards, project cards, and method comparison cards into serialized search entries consumed by BookSearch.",
    },
    {
      ...
      technical: "learningGraph.ts derives typed graph nodes and edges from original chapter, concept, section-mastery, formula, algorithm, case-study, project-studio, method-comparison, worked-example, practice, exercise-solution, simulator, code-lab, assumption-clinic, and dependency modules; LearningGraphExplorer renders the interactive SVG graph on /graph, home, and chapter routes.",
    },
    {
