...
function requirementProofs(totals: CoverageAudit["totals"]): RequirementProof[] {
  return [
    ...
    },
    {
      ...
      technical: "bookIndex.ts aggregates chapter stories, zero-primer rungs, lecture slides, section mastery cards, symbol cards, active recall, concept cards, examples, misconception repairs, simulators, implementation code labs, assumption clinics, manuscripts, section lessons, synthesis/dependency gates, source audits, algorithms, mastery notes, formulas, evidence anchors, exercise coaches, exercise solution cards, and method comparison cards into serialized search entries consumed by BookSearch.",
    },
    {
