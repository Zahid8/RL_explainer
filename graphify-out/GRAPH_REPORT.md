...
## Corpus Check
- 55 files · ~831,369 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 191 nodes · 230 edges · 12 communities detected
...
Cohesion: 0.12
Nodes (15): algorithmsForChapter(), sourceAuditsForChapter(), manuscriptForChapter(), manuscriptSectionCount(), buildCoverageAudit(), chapterCoverageRow(), requirementProofs(), handsOnSequence() (+7 more)
...
- **Are the 6 inferred relationships involving `chapterCoverageRow()` (e.g. with `algorithmsForChapter()` and `chapterSynthesis()`) actually correct?**
  _`chapterCoverageRow()` has 6 INFERRED edges - model-reasoned connections that need verification._
