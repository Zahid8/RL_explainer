...
## Corpus Check
- 58 files · ~837,265 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 201 nodes · 242 edges · 12 communities detected
...
Cohesion: 0.09
Nodes (19): algorithmsForChapter(), sourceAuditsForChapter(), manuscriptForChapter(), manuscriptSectionCount(), buildCoverageAudit(), chapterCoverageRow(), requirementProofs(), blackboardForChapter() (+11 more)
...
- **Why does `chapterCoverageRow()` connect `Community 0` to `Community 4`, `Community 5`?**
